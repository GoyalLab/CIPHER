...
def rank_genes_groups_by_cov(
    ...
    for cov_cat in cov_categories:
        ...
        adata_cov = adata[adata.obs[covariate]==cov_cat].copy()
        adata_cov.obs[groupby] = adata_cov.obs[groupby].cat.remove_unused_categories()

        # skip cell types that have no control cells
        if control_group_cov not in adata_cov.obs[groupby].values:
            continue
